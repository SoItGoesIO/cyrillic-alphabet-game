-- Minimal schema for quick setup
...
create type if not exists item_type as enum ('task','habit','quest');
create type if not exists item_status as enum ('created','in_progress','completed');
