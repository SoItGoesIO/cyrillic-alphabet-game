...
const CyrillicAlphabetGame = () => {
  ...
  if (gameMode === 'learn') {
    ...
    return React.createElement(
      ...
      {
        className:
          'max-w-2xl mx-auto p-6 bg-gradient-to-br from-blue-50 to-purple-50 rounded-xl shadow-lg',
      },
      React.createElement(
        'div',
        ...
        React.createElement(
          ...
          {
            className:
              'text-3xl font-bold text-gray-800 mb-2 flex items-center justify-center gap-2',
          },
        ...
        React.createElement(
          ...
          React.createElement(
            'button',
            {
              ...
              className:
                'px-6 py-3 bg-blue-600 text-white rounded-lg font-semibold hover:bg-blue-700 transition-colors flex items-center gap-2 mx-auto',
            },
        ...
        React.createElement(
          ...
          React.createElement(
            'button',
            {
              ...
              className:
                'px-4 py-2 bg-gray-300 text-gray-700 rounded-lg disabled:opacity-50 hover:bg-gray-400 transition-colors',
            },
            'Previous'
          ),
          React.createElement(
            ...
            `${currentIndex + 1} of ${alphabet.length}`
          ),
          React.createElement(
            'button',
            {
      ...
      React.createElement(
        ...
        React.createElement(
          'button',
          {
            onClick: startQuiz,
            className:
              'px-8 py-3 bg-green-600 text-white rounded-lg font-semibold hover:bg-green-700 transition-colors flex items-center gap-2 mx-auto',
          },
  ...
  if (gameMode === 'quiz') {
    ...
    return React.createElement(
      ...
      {
        className:
          'max-w-2xl mx-auto p-6 bg-gradient-to-br from-green-50 to-blue-50 rounded-xl shadow-lg',
      },
      React.createElement(
        'div',
        { className: 'text-center mb-8' },
      ...
      React.createElement(
        ...
        React.createElement(
          ...
          React.createElement(
            'p',
            { className: 'text-lg text-gray-600 mb-4' },
            'What is the Latin equivalent of this Cyrillic letter?'
          ),
          React.createElement(
            'button',
            {
              onClick: () =>
                playAudio(alphabet.find((letter) => letter.cyrillic === question.question).audio),
              className:
                'px-4 py-2 bg-green-600 text-white rounded-lg font-semibold hover:bg-green-700 transition-colors flex items-center gap-2 mx-auto',
            },
        ...
        React.createElement(
          ...
          ...question.options.map((option, index) => {
            let buttonClass =
              'p-4 text-xl font-semibold rounded-lg border-2 transition-all duration-200 ';
            ...
            if (showAnswer) {
              ...
              buttonClass +=
                'bg-white border-gray-300 text-gray-700 hover:border-green-500 hover:bg-green-50 cursor-pointer';
            }
  ...
  if (gameMode === 'results') {
    ...
    return React.createElement(
      ...
      {
        className:
          'max-w-2xl mx-auto p-6 bg-gradient-to-br from-purple-50 to-pink-50 rounded-xl shadow-lg',
      },
      React.createElement(
        'div',
        { className: 'text-center mb-8' },
      ...
      React.createElement(
        ...
        React.createElement(
          'button',
          {
            onClick: startQuiz,
            className:
              'px-6 py-3 bg-green-600 text-white rounded-lg font-semibold hover:bg-green-700 transition-colors flex items-center gap-2',
          },
